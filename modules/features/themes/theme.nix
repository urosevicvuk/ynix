  ...
  flake.nixosModules.base = {
    ...
    options.theme = lib.mkOption {
      ...
      default = {
        ...
        textColorOnWallpaper = config.lib.stylix.colors.base0D;
        bar = {
          position = "top";
          transparent = true;
    ...
    config.stylix = {
      ...
      base16Scheme = {
        ...
        base08 = "fb4934"; # Variables, XML Tags, Markup Link Text
        base09 = "fe8019"; # Integers, Boolean, Constants, XML Attributes
        base0A = "fabd2f"; # Classes, Markup Bold, Search Text Background
        base0B = "b8bb26"; # Strings, Inherited Class, Markup Code
        base0C = "8ec07c"; # Support, Regular Expressions, Escape Characters
        base0D = "83a598"; # Functions, Methods, Attribute IDs, Headings
        base0E = "d3869b"; # Keywords, Storage, Selector, Markup Italic
